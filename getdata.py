...
filenames = [
		...
		'rheobase/silence_to_-1.91pA.dat',
		'rheobase/silence_to_-1.90pA.dat',
		'square-pulses/-1.90pA.dat',
		'square-pulses/-1.91pA.dat',
		'square-pulses/-2.72pA.dat',
		'square-pulses/-2.73pA.dat'		
